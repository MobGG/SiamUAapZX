        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                if (response.hasProperty("picture")) {
                    ...
                    byte[] decodedString = Base64.decode(response.getPropertyAsString("picture"), Base64.DEFAULT);
                    Bitmap bitmap = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length, options);

                    people.setPeopleImage(bitmap);
                }
...
//                options.inPurgeable = true;
//                Bitmap bitmap = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length, options);
                imageView.setImageBitmap(people.getPeopleImage());
            } else {
